...
const DataTable: React.FunctionComponent<IDataTableProps> = (props) => {
  ...
  const renderTableData = () => {
    ...
    return data.map((item) => {
      return (
        <tr
          key={item._id}
          className="border-b text-white bg-gray-600 hove:bg-white hover:text-gray"
        >
            ...
            <div className="flex content-center">
              ...
              >
                ...
                >
                  ...
                  <path d="M8 14H5.6A2.6 2.6 0 0 1 3 11.4V9m5 6v2m0-11v2m0 6H5.6M16 14h2.4A2.6 2.6 0 0 0 21 11.4V9m-5 6v2m0-11v2m0 6h-2.4M14 5.6A2.6 2.6 0 0 1 16.6 3H19m-5 11H12m2-6v2m-2 0v-2m-2 0H8" />
                </svg>
              </div>
              <div
                className="cursor-pointer px-2"
  ...
  return (
    <div className="container mx-auto pt-2 pb-10">
      ...
      <QRCodeModal isOpen={isModalOpen} qrUrl={qrUrl} onClose={closeModal} />
    </div>
  );
};
